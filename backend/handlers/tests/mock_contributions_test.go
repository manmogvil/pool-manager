...
type mockContributionStore struct {
	...
	getByParticipantFn func(participantID int) ([]models.Contribution, error)
...
func (m *mockContributionStore) GetContributionsByParticipant(participantID int) ([]models.Contribution, error) {
	return m.getByParticipantFn(participantID)
}
