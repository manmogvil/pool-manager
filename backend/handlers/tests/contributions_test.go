	...
	mock := &mockContributionStore{
		getAllFn: func() ([]models.Contribution, error) {
			...
			return []models.Contribution{
				{ID: 1, UserID: 1, GameID: 1, Month: 1, Year: 2024, Amount: 5.00, Paid: true, PaymentDate: &now, PaymentMethod: "CASH"},
			}, nil
		},
	}
...
func TestContributionHandler_Create_Success(t *testing.T) {
	mock := &mockContributionStore{
		createFn: func(c *models.Contribution) (models.Contribution, error) {
			return models.Contribution{ID: 1, UserID: c.UserID, GameID: c.GameID, Amount: c.Amount}, nil
		},
	}

	rr := doContributionRequest(t, mock, "POST", "/contributions",
		`{"user_id": 1, "game_id": 1, "month": 1, "year": 2024, "amount": 5.00, "paid": true, "payment_method": "CASH"}`)
...
func TestContributionHandler_Create_MissingUserID(t *testing.T) {
	mock := &mockContributionStore{}
	rr := doContributionRequest(t, mock, "POST", "/contributions",
...
func TestContributionHandler_Create_MissingGameID(t *testing.T) {
	mock := &mockContributionStore{}
	rr := doContributionRequest(t, mock, "POST", "/contributions",
		`{"user_id": 1, "month": 1, "year": 2024, "amount": 5.00}`)
...
func TestContributionHandler_Create_InvalidMonth(t *testing.T) {
	mock := &mockContributionStore{}
	rr := doContributionRequest(t, mock, "POST", "/contributions",
		`{"user_id": 1, "game_id": 1, "month": 13, "year": 2024, "amount": 5.00}`)
...
func TestContributionHandler_Create_InvalidPaymentMethod(t *testing.T) {
	mock := &mockContributionStore{}
	rr := doContributionRequest(t, mock, "POST", "/contributions",
		`{"user_id": 1, "game_id": 1, "month": 1, "year": 2024, "amount": 5.00, "payment_method": "CARD"}`)
...
func TestContributionHandler_Create_MissingPaymentMethod(t *testing.T) {
	mock := &mockContributionStore{}
	rr := doContributionRequest(t, mock, "POST", "/contributions",
		`{"user_id": 1, "game_id": 1, "month": 1, "year": 2024, "amount": 5.00}`)
...
func TestContributionHandler_Update_Success(t *testing.T) {
	mock := &mockContributionStore{
		updateFn: func(id int, c *models.Contribution) (models.Contribution, error) {
			return models.Contribution{ID: id, UserID: c.UserID, Amount: c.Amount}, nil
		},
	}

	rr := doContributionRequest(t, mock, "PUT", "/contributions/1",
		`{"user_id": 1, "game_id": 1, "month": 1, "year": 2024, "amount": 10.00, "paid": true, "payment_method": "BIZUM"}`)
